...
export type ChartResponse = { type: ChartType; title: string; x_axis: string; y_axis: string; data: Record<string, string | number | null>[]; plan: Record<string, unknown>; interpreted_request: string };
